...
function beforeSaveAsync(context){
    ...
    console.log('before save data okay......');
    var orderItems = me.getAllItems(); 
    debugger;

    // for (let i = 0; i < orderItems.length; i++) {
    //     if (orderItems[i].givenStock > orderItems[i].quantity && orderItems[i].givenStock != orderItems[i].quantity) {
    //       var newError = {
    //         "level": "error",
